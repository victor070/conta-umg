        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Nombre" placeholder="Juan Smit" value='{{$banco[0]->Nombre}}' required autofocus>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-xs-12"> 
                <div class="form-group">
                    ...
                    <input type="number" min='0' minlength="0" maxlength="8"  class="form-control" id="SaldosCuentas" value='{{$banco[0]->SaldosCuentas}}' required
